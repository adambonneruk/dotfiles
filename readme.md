- [Install](#install)
  - [SSH + Yubikey, Git, and Stow](#ssh--yubikey-git-and-stow)
...
- [Application Config and Notes](#application-config-and-notes)
  - [Bash, Shell, Scripts, and Functions](#bash-shell-scripts-and-functions)
  - [Starship](#starship)
  ...
  - [QEMU (Host)](#qemu-host)
  - [QEMU (Windows Guest)](#qemu-windows-guest)
  - [QEMU (Linux Guest)](#qemu-linux-guest)
  - [Docker and Docker Compose](#docker-and-docker-compose)
- [Linux Mint Desktop Environment](#linux-mint-desktop-environment)
  - [Remove Software](#remove-software)
  - [Themes](#themes)
  - [Keybindings](#keybindings)
  - [Login wallpaper](#login-wallpaper)
- [Debian Server Environment](#debian-server-environment)
  - [Add user (adam) to sudoers](#add-user-adam-to-sudoers)
  - [Passwordless ```sudo```](#passwordless-sudo)
  - [Disable Password Authentication (for SSH)](#disable-password-authentication-for-ssh)
- [Dell Latitude 5450 Config](#dell-latitude-5450-config)
  - [Hibernate Fixes](#hibernate-fixes)
